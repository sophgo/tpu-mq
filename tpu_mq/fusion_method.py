...
from tpu_mq.utils.registry import register_convert_function
from tpu_mq.fuser_method_mappings import fuse_deconv_bn_eval
from tpu_mq.quantization.default_bias_fake_quant import bias_fake_quantizer


@register_convert_function(qnniqat.Linear_tpu)
...
@register_convert_function(qnnqat.Conv2d_tpu)
...
@register_convert_function(qnnqat.ConvTranspose2d_tpu)
...
@register_convert_function(qnniqat.LinearReLU_tpu)
...
@register_convert_function(qnniqat.LinearBn1d_tpu)
...
@register_convert_function(qnniqat.ConvBn2d_tpu)
def convert_nniqat_convbn(model, fused_node):
    ...
    fused_module_class_map = {
        ...
        qnniqat.ConvBn2d_tpu: torch.nn.Conv2d,
        qnniqat.ConvBnReLU2d_tpu: torch.nn.Conv2d,
    }
...
@register_convert_function(qnniqat.ConvBnReLU2d_tpu)
...
@register_convert_function(qnniqat.ConvReLU2d_tpu)
...
@register_convert_function(qnniqat.ConvTransposeBn2d_tpu)
...
@register_convert_function(qnniqat.ConvTransposeBnReLU2d_tpu)
...
def convert_qnniqat_convbn(model, fused_node):
    """tpu_mq.nn.intrinsic.qat module add bias quant.
