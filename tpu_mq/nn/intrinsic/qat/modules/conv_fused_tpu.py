...
class ConvBn2d_tpu(_ConvBnNd, nn.Conv2d):
    r"""
...
class ConvBnReLU2d_tpu(ConvBn2d_tpu):
    r"""
    ...
    def __init__(self,
                 ...
                 freeze_bn=False,
                 qconfig=None):
        super(ConvBnReLU2d_tpu, self).__init__(in_channels, out_channels, kernel_size, stride,
    ...
    def forward(self, input):
        return F.relu(ConvBn2d_tpu._forward(self, input))

    @classmethod
    def from_float(cls, mod):
        return super(ConvBnReLU2d_tpu, cls).from_float(mod)

class ConvReLU2d_tpu(qnnqat.Conv2d_tpu, _FusedModule):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 ...
                 qconfig=None):
        super(ConvReLU2d_tpu, self).__init__(in_channels, out_channels, kernel_size,
                                         stride=stride, padding=padding, dilation=dilation,
                                         groups=groups, bias=bias, padding_mode=padding_mode,
                                         qconfig=qconfig)

    def forward(self, input):
        return F.relu(qnnqat.Conv2d_tpu.forward(self, input))
