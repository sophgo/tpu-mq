...
from tpu_mq.utils.fusion import fuse_deconv_bn_weights
...
class ConvTransposeBn2d_tpu(_ConvTransposeBnNd, nn.ConvTranspose2d):
...
class ConvTransposeBnReLU2d_tpu(ConvTransposeBn2d_tpu):
    ...
    def __init__(
        ...
        #                                             freeze_bn,
        #                                             qconfig)
        super(ConvTransposeBnReLU2d_tpu,
    ...
    def forward(self, input):
        return F.relu(ConvTransposeBn2d_tpu._forward(self, input))

    @classmethod
    def from_float(cls, mod):
        return super(ConvTransposeBnReLU2d_tpu, cls).from_float(mod)


class ConvTransposeReLU2d_tpu(qnnqat.ConvTranspose2d_tpu):
    ...
    def forward(self, input, output_size=None):
        return F.relu(qnnqat.ConvTranspose2d_tpu.forward(input, output_size))