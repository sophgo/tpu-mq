...
# cmd_str = f"--epochs={epochs} --deploy_batch_size=10 --cpu --pretrained --evaluate --backend=tpu --optim=sgd \
#            --train_data=/sea/data/imagenet --val_data=/sea/data/imagenet --output_path={output_path} {fast_test} {pre_eval_and_export}"
