...
from tpu_mq.utils import is_tracing_state
...
class FakeQuantizeDSQPerchannel(torch.autograd.Function):
    ...
    def symbolic(g, x, scale, zero_point, quant_min, quant_max, ch_axis, alpha):
        output = g.op("tpu_custom::FakeQuantizeDSQPerchannel", x, scale, zero_point, quant_min_i=quant_min, quant_max_i=quant_max, alpha_f=alpha)
...
class FakeQuantizeDSQPertensor(torch.autograd.Function):
    ...
    def symbolic(g, x, scale, zero_point, quant_min, quant_max, alpha):
        output = g.op("tpu_custom::FakeQuantizeDSQPertensor", x, scale, zero_point, quant_min_i=quant_min, quant_max_i=quant_max, alpha_f=alpha)
