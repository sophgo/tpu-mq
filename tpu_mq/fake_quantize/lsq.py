...
from tpu_mq.utils import is_symmetric_quant, is_tracing_state
...
class FakeQuantizeLearnablePerchannelAffine(torch.autograd.Function):
    ...
    def symbolic(g, x, scale, zero_point, ch_axis, quant_min, quant_max, grad_factor):
        output = g.op("tpu_custom::FakeQuantizeLearnablePerchannelAffine", x, scale, zero_point, quant_min_i=quant_min, quant_max_i=quant_max)
