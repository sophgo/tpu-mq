...
from tpu_mq.utils import getitem2node
import tpu_mq.nn.intrinsic.qat as qnniqat
import tpu_mq.nn.intrinsic as qnni
from tpu_mq.utils.registry import register_model_quantizer
from tpu_mq.custom_quantizer import ModelQuantizer
import torch.nn as nn
import tpu_mq.nn.qat as qnnqat
...
from tpu_mq.utils import get_flattened_qconfig_dict
...
class TpuQuantizer(ModelQuantizer):
    """
    ...
    def __init__(self, extra_quantizer_dict, extra_fuse_dict,quant_dict):
        ...
        if self.quantmode=="weight_activation":
            self.additional_qat_module_mapping = {
                # Intrinsic modules:
                nni.ConvBn2d: qnniqat.ConvBn2d_tpu,
                nni.ConvBnReLU2d: qnniqat.ConvBnReLU2d_tpu,
                nn.Conv2d: qnnqat.Conv2d_tpu,
                nni.ConvReLU2d: qnniqat.ConvReLU2d_tpu,
                nni.LinearReLU: qnniqat.LinearReLU_tpu,
                nn.Linear: qnniqat.Linear_tpu,
                qnni.LinearBn1d: qnniqat.LinearBn1d_tpu,
                qnni.ConvTransposeBnReLU2d:qnniqat.ConvTransposeBnReLU2d_tpu,
                qnni.ConvTransposeReLU2d:qnniqat.ConvTransposeReLU2d_tpu,
                qnni.ConvTransposeBn2d:qnniqat.ConvTransposeBn2d_tpu,
            }
    ...
    def _layers_need_scale_form_input_fake_quantizer(self):
        return (
            qnniqat.ConvBnReLU2d_tpu, #todo:add transposeConv support
            qnniqat.ConvBn2d_tpu,
            qnniqat.ConvReLU2d_tpu,
            qnnqat.Conv2d_tpu,
            qnniqat.LinearReLU_tpu,
            qnniqat.Linear_tpu,
            qnniqat.LinearBn1d_tpu,
            qnniqat.ConvTransposeBnReLU2d_tpu,
            qnniqat.ConvTransposeReLU2d_tpu,
            qnniqat.ConvTransposeBn2d_tpu,
        )

    @property
    def _layers_need_check_is_dw(self):
        return (
            qnniqat.ConvBnReLU2d_tpu,
            qnniqat.ConvBn2d_tpu,
            qnniqat.ConvReLU2d_tpu,
            qnnqat.Conv2d_tpu,
        )
