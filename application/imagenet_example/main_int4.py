...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.quant:
        ...
        extra_prepare_dict['extra_qconfig_dict']['module_name'] = {
            'conv1': {
                'mode': 'weight',
                'bit': 8,
                'wfakequantize': 'LearnableFakeQuantize',
        ...
        '''
        extra_prepare_dict['exclude_module_name']=['layer1.0.conv3', 'layer1.1.conv3','layer1.2.conv3','layer2.0.conv3', 'layer2.1.conv3','layer2.2.conv3',
    ...
    if args.resume:
        ...
        if args.evaluate:
            ...
            convert_deploy(model.eval(), input_shape_dict={'data': [args.deploy_batch_size, 3, 224, 224]},
                model_name='{}'.format(args.arch), output_path=args.output_path, mlir_deploy=args.tpu_deploy, chip=args.chip, val_loader=val_loader)
        exit(0)
...
def prepare_dataloader(args):
    ...
    cali_num = (2000//args.batch_size)*args.batch_size
