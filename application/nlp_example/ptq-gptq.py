...
from tpu_mq.utils.state import enable_quantization, enable_calibration_woquantization, enable_calibration
import re
...
def main(config_path):
    ...
    #     'output_path': './',
    #     'model_name':  'tpu_mq_model_gptq',
    #     'dummy_input': export_inputs, 
    #     'onnx_model_path':  './tpu_mq_model_gptq.onnx',
    # }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/home/zhang/Projects/quantization/tpu_mq/application/nlp_example/config-gptq.yaml', type=str)
